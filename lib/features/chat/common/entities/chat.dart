...
class Chat {
  ...
  factory Chat.fromJson(Map<String, dynamic> json) => Chat(
        from_token:
            json["from_token"] != null ? json["from_token"] as String : null,
        to_token: json["to_token"] != null ? json["to_token"] as String : null,
        msgid: json["msgid"] != null ? json["msgid"] as int : null,
...
class MsgListcontent {
  ...
  factory MsgListcontent.fromJson(Map<String, dynamic> json) => MsgListcontent(
        from_token:
            json["from_token"] != null ? json["from_token"] as String : null,
        from_avatar:
            json["from_avatar"] != null ? json["from_avatar"] as String : null,
        from_name:
            json["from_name"] != null ? json["from_name"] as String : null,
        to_token: json["to_token"] != null ? json["to_token"] as String : null,
        msgid: json["msgid"] != null ? json["msgid"] as int : null,
        content: json["content"] != null ? json["content"] as String : null,
        type: json["type"] != null ? json["type"] as String : null,
...
class SyncMessageResponseEntity {
  ...
  factory SyncMessageResponseEntity.fromJson(Map<String, dynamic> json) =>
      SyncMessageResponseEntity(
        ...
        data: json["data"] == null
            ? []
            : List<MsgListcontent>.from((json["data"] as List).map(
                (x) => MsgListcontent.fromJson(x as Map<String, dynamic>))),
      );
