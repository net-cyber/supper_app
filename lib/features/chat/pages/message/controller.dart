...
class MessageController extends GetxController with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    switch (state) {
      ...
      case AppLifecycleState.detached: // APP结束时调用
        ...
        break;
      case AppLifecycleState.hidden: // Handle the new hidden state
  ...
  CallVocieOrVideo() async {
    ...
    if (res.isNotEmpty) {
      ...
      print(data);
      // "call_role":"audience",
      String to_token = data["to_token"].toString();
      String to_name = data["to_name"].toString();
      String to_avatar = data["to_avatar"].toString();
      String call_type = data["call_type"].toString();
      String doc_id = data["doc_id"] != null ? data["doc_id"].toString() : "";
      DateTime expire_time = DateTime.parse(data["expire_time"].toString());
