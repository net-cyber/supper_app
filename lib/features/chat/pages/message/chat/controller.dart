...
import 'package:super_app/features/chat/common/widgets/toast.dart';
...
class ChatController extends GetxController {
  ...
  void callAudio(BuildContext context) {
    state.more_status.value = false;
    ChatNavigationService.toVoiceCall(
      context,
      docId: doc_id.toString(),
      toToken: state.to_token.value,
      toName: state.to_name.value,
      toAvatar: state.to_avatar.value,
      callRole: "anchor",
    );
  }

  void callVideo(BuildContext context) {
    state.more_status.value = false;
    ChatNavigationService.toVideoCall(
      context,
      docId: doc_id.toString(),
      toToken: state.to_token.value,
      toName: state.to_name.value,
  ...
  sendMessage() async {
    ...
    if (message_res.data() != null) {
      ...
      await db.collection("message").doc(doc_id.toString()).update({
  ...
  sendNotifications(String call_type) async {
    ...
    callRequestEntity.doc_id = doc_id.toString();
