...
class _$LoginUserImpl extends _LoginUser {
  ...
  @override
  String toString() {
    return 'LoginUser(username: $username, full_name: $full_name, avatar: $avatar, token: $token, international_phone_number: $international_phone_number, phone_verified: $phone_verified, password_changed_at: $password_changed_at, created_at: $created_at)';
  }
